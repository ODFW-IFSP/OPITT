...
print(ggplot(data=MSI_ESU, aes(x=ReturnYear, y=MSAdjMARSS)) +
        xlab("Return Year") +
        ylab("Adj Marine Survival") +
        ggtitle(paste("MSI Alternatives")) +
        geom_line(color="orange",linewidth=1.5) + 
        geom_point(color="orange", size = 2) +
        #geom_line(aes(y=MSAdjOG), col='black', linewidth=1.5) +
        #geom_point(aes(y=MSAdjOG), col='black', size = 2) +
